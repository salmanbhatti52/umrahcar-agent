...
class GetBookingPendingById {
  String? status;
  List<GetBookingData1>? data;
  ...
  factory GetBookingPendingById.fromJson(Map<String, dynamic> json) => GetBookingPendingById(
    status: json["status"],

    data: List<GetBookingData1>.from(json["data"].map((x) => GetBookingData1.fromJson(x))),
  );
...
class GetBookingData1 {
  String? bookingsPendingId;
  String? bookingsId;
  String? parentId;
  ...
  factory GetBookingData1.fromJson(Map<String, dynamic> json) => GetBookingData1(
    bookingsPendingId: json["bookings_pending_id"],
  ...
  Map<String, dynamic> toJson() => {
    "bookings_pending_id": bookingsPendingId,
