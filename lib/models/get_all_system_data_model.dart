...
//
//     final getAllSystemData = getAllSystemDataFromJson(jsonString);

import 'dart:convert';

GetAllSystemData getAllSystemDataFromJson(String str) => GetAllSystemData.fromJson(json.decode(str));

String getAllSystemDataToJson(GetAllSystemData data) => json.encode(data.toJson());
