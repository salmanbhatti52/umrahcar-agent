...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  getProfile()async{
    ...
    if(getProfileResponse.data !=null ) {
      ...
      nameController.text=getProfileResponse.data.name;
      emailController.text=getProfileResponse.data.email;
      cityController.text=getProfileResponse.data.city;
      contactNumberController.text=getProfileResponse.data.contact;
      whatsappNumberController.text=getProfileResponse.data.whatsapp;
      businessNameController.text= getProfileResponse.data.agency;
    }
    setState(() {
                ...
                GestureDetector(
                    onTap: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        print("password: ${getProfileResponse !=null ? "${getProfileResponse.data.password}":"123456"}");

                        var mapData={
                          "users_agents_id":"$userId",
                          "name":nameController.text,
                          "email": emailController.text,
                          "password": getProfileResponse !=null ? "${getProfileResponse.data.password}":"123456",
                          "agency":businessNameController.text,
                          "address":getProfileResponse !=null ? "${getProfileResponse.data.address}":"h1 ",
                          "city": cityController.text,
                          "state":getProfileResponse !=null ? "${getProfileResponse.data.state}":"Punjab",
                          "country":getProfileResponse !=null ? "${getProfileResponse.data.country}":"Pakistan",
                          "contact":contactNumberController.text,
                          "mobile":getProfileResponse !=null ? "${getProfileResponse.data.mobile}":"1234567890",
